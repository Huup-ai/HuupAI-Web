        ...
        <div className="landing-page">
            <div className="overlap">
                ...
                <div className="overlap-group">
                    ...
                    <div className="navigation-bar">
                        <div className="frame">
                            ...
                            <button className="button">
                                <div className="div" onClick={handleStartClick}>Log in</div>    
                    ...
                    {/* <img className="overlap-image" alt="Background" src="https://s3-alpha-sig.figma.com/img/4d2f/e72f/ed6e6abc8a9a49656c83c0270223ccdf?Expires=1698624000&Signature=G7dPDzjfIauS567UbK3WBjf2d9ASsXrI4kgnU4RMhDdzceiJWd0Jxe6YIJgIC5gsuDOJ7NW7eSghT9Hz-nOtInIiOgmr5z1PO6TOFT9Ma~LkFoRnMFl6MAKarHp81IgiJDCQhcpNsQz-DFIJoZxBUYB2oy03Cx8bvBG3jEhPbjxxtfR4ozBMUwNDFUOdTd-PUHc9NHaqv5xH5NyVMZtqj85Y0SO90J70LpVuEKE96IbGiF4hhAgcMs3E28e70TMjUTdNqPdLHG30Gg-HDww4BPK9dx1gm08AfrKLDITmvAczd9ZPMmCovrtMIpv9pSIQRn3FMOfm4vLwhLSweXHRpw__&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4" /> */}
                    

                    <p className="enhance-LLM">
                        ENHANCE LLM <br />
                        RELIABILITY AND AFFORDABILITY <br/>
                        <button className="start-button-2" onClick={handleStartClick}>Get Start</button>
                    </p>
                    

                    
                    {/* <img className="subtract" alt="Subtract" src="/images/Ellipse 3.png" /> */}
                    {/* <img className="img" alt="Subtract" src="images/LooperGroup.png" /> */}
                    ...
                    <div className="frame-4">
                        <div className="div-wrapper">
                            <div className="text-wrapper-6">Our partnership</div>
                        </div>
                        <img className="mask-group" alt="Mask group" src="images/AI logo.png" />
                        ...
                        <img className="tencent-cloud-logo" alt="Tencent cloud logo" src="images/tencent-cloud logo.png" />
                        <img className="frame-5" alt="Frame" src="/images/Frame 9.png" />
                    </div>
                </div>
